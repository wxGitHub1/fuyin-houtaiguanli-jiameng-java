<template>
  <div>
    ...
    <el-row class="search">
      ...
      <el-col :span="2" class="input-title">
        <span class="time_style">评价状态</span>
      </el-col>
      <el-col :span="2">
        <el-select clearable size="small" v-model="seach.appraisalValue" placeholder="请选择">
          <el-option
    ...
    <el-row class="office_performance">
      ...
      <el-col :span="2">
        <el-select clearable size="small" v-model="seach.statusValue" placeholder="请选择">
          <el-option
