...
<template>
  <div>
    ...
    >
      ...
      <el-table-column align="center" prop="sex" label="出生日期"></el-table-column>
      <el-table-column align="center" prop="vip" label="是否会员"></el-table-column>
      <el-table-column align="center" prop="saleProductNickname" label="创建日期"></el-table-column>
      <el-table-column align="center" prop="backVisitUserName" label="测评状态"></el-table-column>
      <el-table-column align="center" prop="visitTypeString" label="初次测评人员"></el-table-column>
      <el-table-column align="center" prop="outflowTime" label="客户当前类型"></el-table-column>
      <el-table-column align="center" prop="outflowReason" label="沟通结果"></el-table-column>
      <el-table-column align="center" prop="outflowReason" label="初次测评时间"></el-table-column>
    </el-table>
    <el-pagination
