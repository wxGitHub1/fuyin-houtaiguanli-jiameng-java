      ...
      <div class="clearfix">
        ...
        >
          ...
          >
            ...
            <el-table-column prop="experienceUseTime" label="每天使用时间"></el-table-column>
            <el-table-column label="产品问题">
              <template slot-scope="scope">
...
<el-table
        ...
        <el-col :span="3">
          <div class="line-h-30 text-r">下次回访时间：</div>
        </el-col>
        <el-col :span="3">
          <div>
            <el-date-picker
                ...
                <el-row class="margin-t-20 margin-b-20">
                  <el-col :span="12" class="border-r-1">
                    ...
                    <el-row class="padding-tb-20">
                      ...
                      <el-col :span="16">
                        <div>
                          <el-radio-group v-model="item.useUseTime">
                    ...
                    <el-row class="padding-tb-20">
                      ...
                      <el-col :span="16">
                        <div>
                          <el-checkbox-group v-model="item.useNotice">
                            <el-checkbox v-for="item in zysx_1" :label="item" :key="item">{{item}}</el-checkbox>
                          </el-checkbox-group>
                          <!-- <el-radio-group v-model="item.useNotice">
                  ...
                  <el-col :span="12">
                    ...
                    <el-row class="padding-tb-10">
                      ...
                      <el-col :span="19">
                        <div>
                          <el-radio-group v-model="item.useProblemHave">
                            <el-radio v-for="item in isYW" :key="item" :label="item"></el-radio>
                          </el-radio-group>
                        </div>
                      </el-col>
    ...
    >
      ...
      <div slot="footer" class="dialog-footer">
        ...
        >取消</el-button>
        <el-button
          @click="data_assignment_save_two(1)"
          type="success"
...
<script>
import {
  selectUseWaitVisitList,
  selectUseWaitVisitDetail,
  queryExamineDetail,
  ...
  printMakeParam,
  examinePadZb3d,
  selectPrincipalVisitListWhenUse,
  updatePrincipalUser
} from "../../api/javaApi";
import {
  exportMethod,
...
export default {
  ...
  methods: {
    ...
    async data_assignment_pageList() {
      ...
      selectPrincipalVisitListWhenUse(data)
        .then(res => {
          if (res.data.returnCode != 0) {
            this.$message({
              type: "warning",
