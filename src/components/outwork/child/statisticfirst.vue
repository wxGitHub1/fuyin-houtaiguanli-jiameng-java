<template>
  ...
  <div class="container" style="height: 750px;overflow-y: scroll">
    <el-row>
      ...
      >
        <el-row>
          ...
          <el-col :span="2" style="width: 7.5%;text-align: center;line-height: 30px;">查体时间：</el-col>
          <el-col :span="4">
            <el-date-picker
    ...
    <el-row class="search">
      ...
      <el-col :span="2" style="width: 7.5%;text-align: center;line-height: 30px;">录入时间：</el-col>
      <el-col :span="4">
        <el-date-picker
      ...
      <el-col :span="2" style="margin-left: 1%;">
        <el-button type="danger" size="small" @click="outExcel()">导出Excel</el-button>
      </el-col>
      <el-col :span="1" style="text-align:center;margin-left: 1%;">
        <el-button type="success" size="small" @click="searchData()">查询</el-button>
      </el-col>
    </el-row>
    ...
    <el-row class="statistic_row" style="margin-top: 15px;">
      ...
      <el-col :span="3">
        <span>查体总人数：{{totalStatistic.physicalIdTotalCount}}</span>
      </el-col>
      <el-col :span="3">
        <span>问题总人数：{{totalStatistic.problemCount}}</span>
      </el-col>
      <el-col :span="3">
        <span>足弓发育不良：{{totalStatistic.poorarchcount}}</span>
      </el-col>
      <el-col :span="2">驼背: {{totalStatistic.humpbackCount}}</el-col>
      <el-col :span="2">
        <span>跟骨内翻：{{totalStatistic.calcanealvarus}}</span>
      </el-col>
      <el-col :span="2">
        <span>跟骨外翻：{{totalStatistic.heelboneeversion}}</span>
      </el-col>
      <el-col :span="2">
        <span>膝外翻：{{totalStatistic.genylegCount}}</span>
      </el-col>
      <el-col :span="2">
        <span>膝内翻：{{totalStatistic.bandylegCount}}</span>
      </el-col>
      <el-col :span="2">
        <span>膝过伸：{{totalStatistic.kennlegCount}}</span>
      </el-col>
    </el-row>
    <el-row class="statistic_row">
      <el-col :span="3" style="margin-left: 33.1%;">长短腿: {{totalStatistic.longshortlegCount}}</el-col>
      <el-col :span="2">拇外翻: {{totalStatistic.halluxvalgusCount}}</el-col>
      <el-col :span="2">斜颈: {{totalStatistic.torticollisCount}}</el-col>
      <el-col :span="2">高低肩: {{totalStatistic.highlowshoulderCount}}</el-col>
      <el-col :span="2">鸡胸:{{totalStatistic.chickenbreastCount}}</el-col>
      <el-col :span="2">脊柱侧弯: {{totalStatistic. scoliosisCount}}</el-col>
      <el-col :span="2">膝屈曲:{{totalStatistic.kneebuckling}}</el-col>
    </el-row>
    <el-row class="statistic_row">
      <el-col :span="3" style="margin-left: 33.1%;">骨盆倾斜: {{totalStatistic.inclinationCount}}</el-col>
      <el-col :span="2">足内旋: {{totalStatistic.pronation}}</el-col>
      <el-col :span="2">足外旋: {{totalStatistic.pronationout}}</el-col>
      <el-col :span="2">足内翻: {{totalStatistic.strephenopodia}}</el-col>
      <el-col :span="2">
        <span>足外翻：{{totalStatistic.strephenopodiaout}}</span>
      </el-col>
    </el-row>
  </div>
</template>
...
export default {
  ...
  methods: {
    ...
    async outExcel() {
      ...
      // let baseUrl = 'http://192.168.3.220:83/api/Userphysical/ExportRepeat';
      // let envUrl = 'http://117.34.105.87:88/api/Userphysical/ExportRepeat';
