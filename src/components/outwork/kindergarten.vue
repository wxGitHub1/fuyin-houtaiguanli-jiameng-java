<template>
  ...
  <div class="container" style="height: 750px;overflow-y: scroll">
        ...
        <el-row>
          <el-col :span="2" style="text-align:center">
            ...
            >
              ...
              <el-row style="margin-top: 30px;">
                ...
                <el-col :span="2" style="width: 11.2%;line-height: 30px;text-align:left;">
          ...
          >
            <el-row>
              ...
              <el-col :span="3">
                <el-select
                  ...
                  @change="getSchoolId(modifyData.community, type=1)"
                >
                  <el-option
                    v-for="item in communityList"
                    :key="item.communityId"
            ...
            <el-row style="margin-top: 30px;">
              ...
              <el-col :span="3" style="width: 10%;line-height: 30px;text-align:left;">
              ...
              <el-col :span="3" style="text-align: left">
                <el-input placeholder="请输入班级" v-model="modifyData.className" size="small"></el-input>
              </el-col>
              <el-col :span="2" style="width: 6%;line-height: 30px;margin-left: 1%;">
                <span>年级:</span>
              </el-col>
              <el-col :span="3" style="text-align: left">
                <el-input placeholder="请输入年级" v-model="modifyData.grade" size="small"></el-input>
              </el-col>
            </el-row>
            <el-row
              style="margin-top: 30px;padding-bottom: 30px;border-bottom: 1px solid rgb(228,228,228);"
            >
              ...
              <el-col :span="2" style="width: 4.9%;line-height: 30px;margin-left: 1%;">
                <span>出生日期:</span>
              </el-col>
              <el-col :span="3">
              ...
              <el-col :span="3" style="text-align: left">
                <el-input placeholder="请输入老师姓名" v-model="modifyData.teacherName" size="small"></el-input>
              </el-col>
              <el-col :span="2" style="width: 6%;line-height: 30px;margin-left: 1%;">
                <span>老师电话:</span>
              </el-col>
              <el-col :span="3" style="text-align: left">
                <el-input placeholder="请输入联系电话" v-model="modifyData.teacherTel" size="small"></el-input>
              </el-col>
            </el-row>
            <el-row style="margin-top: 30px;">
              <el-col :span="2" :offset="2">
          ...
          <el-col :span="2" style="text-align: left">
            <el-input placeholder="请输入姓名" v-model="search.examPeople" size="small"></el-input>
          </el-col>
          <el-col :span="2" style="width: 5.5%;line-height: 30px;margin-left:1%;">
            <span>查体周期:</span>
          </el-col>
          <el-col :span="2">
            <el-select
              ...
              :clearable="true"
              value-key="zoom"
              v-model="search.physicalPeriod"
            >
              <el-option
                v-for="item in physicalPeriod"
                :key="item.zoom"
                :value="item"
                :label="item.type"
              ></el-option>
    ...
    <el-row class="search">
      ...
      <el-col :span="2" style=";text-align: left">
        <el-input placeholder="输入幼儿园名称" v-model="search.schoolName" size="small"></el-input>
      </el-col>
    ...
    <el-row class="client_table" style="min-height: 580px;">
      <el-col :span="24">
        ...
        >
          ...
          <el-table-column align="center" prop="teacherTel" label="老师电话" min-width="80"></el-table-column>
          <el-table-column align="center" prop="teacherName" label="老师姓名" min-width="80"></el-table-column>
          ...
          <el-table-column align="center" prop="quarter" label="季节" min-width="60"></el-table-column>
          <el-table-column align="center" prop="physicalPeriod" label="查体周期" min-width="60"></el-table-column>
...
export default {
  ...
  methods: {
    ...
    async outExcel() {
      ...
      if (this.search.physicalPeriod) {
        arg.whereLambda.physicalPeriod = this.search.physicalPeriod.zoom; //查体周期
      } else {
        arg.whereLambda.physicalPeriod = 0;
      }

      if (this.search.sex) {
        arg.whereLambda.sex = this.search.sex.zoom; //性别
      } else {
        arg.whereLambda.sex = 0;
      }
      ...
      let baseUrl =
        // 上线地址
        // "http://117.34.105.87:88/api/UserphysicalForGarden/ExportOutGardenUserphysicals";
        // 测试地址
        "http://192.168.3.220:83/api/UserphysicalForGarden/ExportOutGardenUserphysicals?";
      ...
      let exportArg =
        ...
        "&physicalPeriod=" +
        arg.whereLambda.physicalPeriod +
        "&userName=" +
    ...
    async getControlCommunities(pageIndex = 1, pageSize = 10) {
      ...
      if (this.search.physicalPeriod) {
        ...
        arg.whereLambda.physicalPeriod = null;
      }
    ...
    async getSchoolId(item) {
      ...
      if (currentCommunity) {
        try {
          await getSchool({ communityId: currentCommunity })
            .then(res => {
              if (res.data.Error) {
    ...
    handleOrder(item) {
      ...
      if (item) {
        ...
        this.modifyData.schoolName = item.schoolName;
        this.modifyData.schoolId = item.schoolId;
        this.modifyData.userphysicalId = item.userphysicalId;
        this.modifyData.birthday = item.birthday;
        this.modifyData.className = item.className;
        this.modifyData.grade = item.gradeName;
        this.modifyData.teacherName = item.teacherName;
        this.modifyData.teacherTel = item.teacherTel;
        if (item.bak) {
    ...
    async saveInputData(type) {
      ...
      console.log(allData);
        ...
        inputDatas.classId = allData.className;
        inputDatas.gradeId = allData.grade;
        inputDatas.teacherName = allData.teacherName;
        inputDatas.teacherTel = allData.teacherTel;
        ...
        if (isString(allData.schoolName)) {
          inputDatas.schoolId = allData.schoolId;
        } else {
          inputDatas.schoolId = allData.schoolName.schoolId
        }
        ...
        inputDatas.physicalTime = isString(allData.examTime) ? allData.examTime : timeFormat(allData.examTime);

        console.log(inputDatas);
      }
      try {
        return new Promise((resolve, reject) => {
          gardenOperate(inputDatas)
            .then(res => {
              resolve(res);
              const loading = this.$loading({
                lock: true,
